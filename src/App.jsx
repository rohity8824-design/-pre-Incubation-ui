        ...
        <div className="modal-box" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="view-section">
            ...
            <div className="view-grid">
              ...
              <div><label>Office Address</label><p>{viewingStartup.office_address || "—"}</p></div>
              ...
              <div><label>Stage of Startup</label><p>{viewingStartup.startup_stage || "—"}</p></div>
              <div className="full"><label>Problem Statement</label><p>{viewingStartup.problem_statement || "—"}</p></div>
              <div><label>Value Proposition</label><p>{viewingStartup.value_proposition || "—"}</p></div>
              <div><label>USP</label><p>{viewingStartup.usp || "—"}</p></div>
              <div><label>Target Customer</label><p>{viewingStartup.target_customer || "—"}</p></div>
              <div><label>Competitors</label><p>{viewingStartup.competitors || "—"}</p></div>
              <div><label>Scale-up Plan</label><p>{viewingStartup.scale_up_plan || "—"}</p></div>
              <div><label>Revenue Model</label><p>{viewingStartup.revenue_model || "—"}</p></div>
              ...
              <div><label>Govt Scheme Support</label><p>{viewingStartup.govt_support || "—"}</p></div>
          ...
          <div className="view-section">
            ...
            <div className="view-grid">
              <div><label>Founder</label><p>{viewingStartup.founder_name || "—"}</p></div>
              <div><label>Co-founder(s)</label><p>{viewingStartup.co_founder_name || "—"}</p></div>
              ...
              <div><label>LinkedIn Profiles</label><p>{viewingStartup.linkedin_profiles || "—"}</p></div>
              <div><label>Full-time Employees</label><p>{viewingStartup.full_time_employees || "—"}</p></div>
            </div>
          </div>

          <div className="view-section">
            <h3>4. Requirement from Incubator</h3>
            <div className="view-grid">
              <div><label>Why Applying</label><p>{viewingStartup.why_applying || "—"}</p></div>
              <div><label>Expectations</label><p>{viewingStartup.expectations || "—"}</p></div>
          ...
          <div className="view-section no-print">
            ...
            <div className="view-grid">
              <div><label>Pitch Deck</label><a className="dl-link" href={`${BASE_URL}/download/${viewingStartup.pitch_deck}`} target="_blank" rel="noreferrer">Download</a></div>
              <div><label>Resume</label><a className="dl-link" href={`${BASE_URL}/download/${viewingStartup.resume}`} target="_blank" rel="noreferrer">Download</a></div>
              <div><label>PAN Card</label><a className="dl-link" href={`${BASE_URL}/download/${viewingStartup.pan_card}`} target="_blank" rel="noreferrer">Download</a></div>
              <div><label>Certificate</label><a className="dl-link" href={`${BASE_URL}/download/${viewingStartup.certificate}`} target="_blank" rel="noreferrer">Download</a></div>
              <div><label>Business Plan</label><a className="dl-link" href={`${BASE_URL}/download/${viewingStartup.business_plan}`} target="_blank" rel="noreferrer">Download</a></div>
              {viewingStartup.other_document && (
                <div><label>Other Document</label><a className="dl-link" href={`${BASE_URL}/download/${viewingStartup.other_document}`} target="_blank" rel="noreferrer">Download</a></div>
              )}
            </div>
          </div>
